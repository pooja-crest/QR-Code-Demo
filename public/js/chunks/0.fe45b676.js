...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    if (["admin"].includes(this.authenticatedUser.role)) {
      ...
      this.logoRoute = "/products";
      this.menus = Object(_NavbarCustomData__WEBPACK_IMPORTED_MODULE_2__["receiving"])();
    } else if (["display"].includes(this.authenticatedUser.role)) {
      this.logoRoute = "/products";
      this.menus = Object(_NavbarCustomData__WEBPACK_IMPORTED_MODULE_2__["display"])();
    } else if (["order_tracking"].includes(this.authenticatedUser.role)) {
      this.logoRoute = "/products";
      this.menus = Object(_NavbarCustomData__WEBPACK_IMPORTED_MODULE_2__["orderTracking"])();
    }
  }
});
...
/*!*****************************************************!*\
  !*** ./resources/js/components/NavbarCustomData.js ***!
  \*****************************************************/
/*! exports provided: adminPurchaser, admin, viewer, receiving, display, orderTracking */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "receiving", function() { return receiving; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "display", function() { return display; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "orderTracking", function() { return orderTracking; });
...
var receiving = function receiving() {
  var menuArr = [{
    url: "/receives",
    name: "Receive",
    slug: "receives",
