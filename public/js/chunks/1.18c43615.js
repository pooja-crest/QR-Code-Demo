...
/* harmony import */ var _Helpers_validationHelper__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @/Helpers/validationHelper */ "./resources/js/Helpers/validationHelper.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: "ProductList",
  mixins: [_apis_userApi__WEBPACK_IMPORTED_MODULE_3__["default"], _apis_authenticationApi__WEBPACK_IMPORTED_MODULE_4__["default"], _apis_productApi__WEBPACK_IMPORTED_MODULE_1__["default"], _apis_supplierApi__WEBPACK_IMPORTED_MODULE_2__["default"]],
  data: function data() {
    return {
      conditions: {
        data_each_page: 50,
  ...
  computed: {
    ...
    allowSubmitUpdateProduct: function allowSubmitUpdateProduct() {
  ...
  methods: {
    numberType: _Helpers_validationHelper__WEBPACK_IMPORTED_MODULE_5__["numberType"],
    alphaNumberic: _Helpers_validationHelper__WEBPACK_IMPORTED_MODULE_5__["alphaNumberic"],
    deleteProduct: function deleteProduct(product) {
      var _this = this;

      this.$swal({
        title: "Are you sure?",
        text: "Please confirm to delete ".concat(product.label),
        icon: "warning",
        ...
        if (result.isConfirmed) {
          ...
          _this["delete"](product.id).then(function (_ref) {
            var data = _ref.data;
    ...
    generateQRCode: function generateQRCode(event) {
      ...
      this.generateQRCodes(params).then(function (_ref2) {
        ...
        if (success) {
          ...
          _this2.inputs.product.qr_code = data.image_name;
        }
      });
    },
    ...
    resetProductsInputs: function resetProductsInputs() {
      ...
      if (product != null) {
        ...
        this.inputs.product.lead_time = product.lead_time; // this.inputs.product.image = product.image;
        ...
        console.log('qr>>', this.generated_qr_image);
      } else {
        this.removeQrCode();
      }
    },
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function showInputProductModal$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              product = _args2.length > 0 && _args2[0] !== undefined ? _args2[0] : null;
              _context2.next = 3;
    ...
    onChangeFileUpload: function onChangeFileUpload($event) {
      ...
      if ($event.target.files) {
        ...
        reader.onload = function (e) {
          _this6.uploaded_img = e.target.result;
        };
    ...
    submitUpdateProduct: function submitUpdateProduct() {
      var _this8 = this;
      ...
      fd.append("lead_time", this.inputs.product.lead_time);
      fd.append("qr_code", this.inputs.product.qr_code);
      this.update(this.inputs.product.selected_product, fd).then(function (response) {
        if (!response.success) {
          _this8.$notify({
            group: "notification",
            type: "warn",
          ...
          _this8.conditions.edit_product = false;
          _this8.show_modal_input_product = false;

          _this8.resetProductsInputs();
    ...
    inactiveUserApproval: function inactiveUserApproval() {
      ...
      this.authenticationApi_inactiveUserApproval(this.inactive_user_details.id, approval).then(function (_ref6) {
        var data = _ref6.data;
        _this9.show_modal_inactive_product = false;

        _this9.getProductsDatas();
      })["finally"](function () {
        return loading.hide();
      });
    },
                              ...
                              ? _vm._l(_vm.datas.products, function(
                                  ...
                                  return _c(
                                    ...
                                    [
                                      ...
                                      _vm._v(" "),
                                      _c("p", { staticClass: "w-1/4" }, [
                                        _vm._v(_vm._s(product.created_at_date))
                                      ]),
                                      _vm._v(" "),
                                      _c("p", { staticClass: "w-1/4" }, [
                                        _vm._v(_vm._s(product.updated_at_date))
                                      ]),
                                      _vm._v(" "),
                                      _c(
                                        "p",
                                        ...
                                        [
                                          ...
                                          _c(
                                            ...
                                            {
                                              staticClass:
                                                "btn btn-outline-primary p-1 flex items-center justify-center ml-2",
                                              staticStyle: {
                                                "min-width": "initial"
                                              },
                                              attrs: {
                                                href: product.pdf_path,
                                                target: "_blank"
                                              }
                                            },
                                            [
                    ...
                    [
                      ...
                      _c(
                        ...
                        [
                          ...
                          _vm._v(" "),
                          _c("div", { staticClass: "w-full mt-2" }, [
                            _vm.uploaded_img != null
                              ? _c("img", {
                                  attrs: {
                                    src: _vm.uploaded_img,
                                    height: "100",
                                    width: "100"
                                  }
                                })
                              ...
                              ? _c(
                                  "button",
                                  {
                                    ...
                                    attrs: {
                                      type: "button",
                                      disabled:
                                        _vm.inputs.product.item_no === "" ||
                                        _vm.inputs.product.item_no === null
                                    },
              ...
              _vm.allowSubmitAddUProduct && !_vm.conditions.edit_product
                ...
                ? _c(
                    "button",
                    {
                      ...
                      on: {
                        click: function($event) {
                          return _vm.submitUpdateProduct()
                        }
                      }
                    },
                    [
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  }), _defineProperty(_methods, "update", function update(id) {
    var _this3 = this;
  ...
  }), _defineProperty(_methods, "delete", function _delete(id) {
    var _this4 = this;
