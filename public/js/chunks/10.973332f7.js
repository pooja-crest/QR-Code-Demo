...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    generateQRCode: function generateQRCode(e) {
      var _this2 = this;
                            ...
                            _vm.generated_qr_image === null
                              ? _c(
                                  "button",
                                  {
                                    ...
                                    on: {
                                      click: function($event) {
                                        return _vm.generateQRCode(_vm.e)
                                      }
                                    }
                                  },
...
/*!**********************************************!*\
  !*** ./resources/js/Helpers/commonHelper.js ***!
  \**********************************************/
/*! exports provided: imageUrl, imgFolder */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "imageUrl", function() { return imageUrl; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "imgFolder", function() { return imgFolder; });
var imgFolder = {
  'qr': 'QRs'
};

var imageUrl = function imageUrl(folder, img) {
  var url = url("/images/img/".concat(folder, "/").concat(img)); // let url = new URL(`../../public/images/img/${folder}/${img}`, import.meta.url);
