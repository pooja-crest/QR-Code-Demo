...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    submitAddProduct: function submitAddProduct() {
      ...
      fd.append("supplier_id", this.product.supplier_id);
      fd.append("quantity", this.product.quantity);
      fd.append("description", this.product.description);
      fd.append("image", this.product.image);
      fd.append("loaction", this.product.loaction);
      fd.append("item_no", this.product.item_no);
      fd.append("lead_time", this.product.lead_time);
      this.create(this.inputs.user).then(function (response) {
        if (!response.success) {
          _this5.$notify({
            group: "notification",
            type: "warn",
