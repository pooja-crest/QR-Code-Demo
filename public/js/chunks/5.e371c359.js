...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: "VendorList",
  mixins: [_apis_vendorApi__WEBPACK_IMPORTED_MODULE_1__["default"]],
  data: function data() {
    return {
      conditions: {
        data_each_page: 50,
    ...
    getVendorDetails: function getVendorDetails(vendor_id) {
      ...
      this.vendorApi_getOne({
        ...
        if (response.success && response.data != "") {
          ...
          _this3.show_modal_vendor_detail = true; // this.getReceiverMessages(this.inputs.chat.selected_receiver_id);
        }
      });
    },
    editVendorDetails: function editVendorDetails(vendor_id) {
      ...
      this.vendorApi_getOne({
        ...
        if (response.success && response.data != "") {
          ...
          _this4.show_modal_edit_vendor_detail = true; // this.getReceiverMessages(this.inputs.chat.selected_receiver_id);
        }
      });
    },
