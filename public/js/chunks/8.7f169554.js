...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    if (["admin", "purchaser"].includes(this.authenticatedUser.role)) {
      ...
      console.log(_NavbarCustomData__WEBPACK_IMPORTED_MODULE_2__["adminPurchaser"]);
      this.menus = _NavbarCustomData__WEBPACK_IMPORTED_MODULE_2__["adminPurchaser"]; // this.menus.push({
      // 	url: "/orders",
